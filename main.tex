...
This is particularly critical for models such as Fast, Lean and Accurate (FLA), whose primary strength is client-side efficiency.
...
we start by defining a set $\Theta$, it will contain a sample of strings taken from a i.i.d.\footnote{Indepently,Identically Distributed} distribution $\Psi$ based on the internal one of the model.
